    ...
    return (
        <div className='contact'>
            <div className="contact-up">
                ...
                <div className="contact-right"> <img src='https://www.mcall.com/wp-content/uploads/migration/2023/01/04/QYL7YNKXS5CLVHTRBDKH4SHLSA.jpg?w=1024' height="100%" width="100%" alt='Our new pizza shop'></img></div>
            </div>
